...
def main():
    ...
    casualPhrasing = [askGipity(f"""
                                Rewrite the questions to a first person persepctive simular to r/ docs on reddit. Get rid of all information that
                                a user would need to visit a doctor to know (lab values, test results, blood pressure, pulse, respirations, oxygen saturation). Write it simularily to these examples: First example:  
